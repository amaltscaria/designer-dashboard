          ...
          <ScrollAnimation>
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-4">
                A centralized dashboard designed for stakeholders and clients
              </p>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                Enabling effortless customization of web interfaces to meet unique requirements
              </p>
            </div>
          </ScrollAnimation>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <p className="text-gray-500 text-sm">
              © 2025 Designer Dashboard. Crafted with passion for exceptional user experiences.
            </p>
          </div>
        </div>
      </footer>
